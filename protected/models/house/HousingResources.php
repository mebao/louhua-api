...
class HousingResources extends EActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('user_have_id, user_want_id, floor_level, expect_floor_low, project_id, unit_type, expect_floor_high', 'numerical', 'integerOnly' => true),
            array('user_have_name, user_want_name, project_name, price, exposure, action, unit_status', 'length', 'max' => 50),
            array('coop', 'length', 'max' => 10),
            array('situation', 'length', 'max' => 200),
